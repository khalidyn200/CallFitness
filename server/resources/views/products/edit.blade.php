                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('title', $product->title) }}" required>
                        </div>

                        <div class="mt-4">
                            <label for="short_description" class="block text-sm font-medium text-gray-700">Short Description</label>
                            <textarea name="short_description" id="short_description" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('short_description', $product->short_description) }}</textarea>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            @if($product->pictures)
                                <img src="{{ Storage::url($product->pictures) }}" alt="Product Image" class="mt-2" style="max-width: 150px;">
                            @endif
                        </div>
